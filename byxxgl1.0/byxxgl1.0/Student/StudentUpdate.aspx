<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="StudentUpdate.aspx.cs" Inherits="Student_StudentUpdate" %>
    ...
    <table border="3" class="auto-style14">
        ...
        <tr>
            <td class="auto-style7" colspan="2">
                <asp:Button ID="Button2" runat="server" PostBackUrl="~/Student/Student.aspx" Text="提交" />
            </td>
        </tr>
    </table>
</asp:Content>
